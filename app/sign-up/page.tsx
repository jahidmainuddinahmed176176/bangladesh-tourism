    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <Image
          ...
          alt="Beautiful mountains of Bandarban"
          fill
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-12 text-primary-foreground">
          ...
          >
            ...
            <p className="text-lg text-primary-foreground/90 max-w-md mb-8">
              Join thousands of travelers who have discovered the magic of Bangladesh with us.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background overflow-y-auto">
        ...
        >
          ...
          <Link href="/" className="lg:hidden flex items-center gap-2 mb-8 justify-center">
            ...
            <div>
              <span className="text-xl font-bold text-foreground">Bangladesh</span>
          ...
          <Card className="border-0 shadow-xl">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription>
                Sign up to start exploring Bangladesh
              </CardDescription>
            </CardHeader>
            <CardContent>
