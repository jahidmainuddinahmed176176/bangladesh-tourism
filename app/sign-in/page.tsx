    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <Image
          ...
          alt="Beautiful tea gardens of Sylhet"
          fill
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-12 text-primary-foreground">
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-4 text-balance">Welcome Back, Explorer</h2>
            <p className="text-lg text-primary-foreground/90 max-w-md">
              Continue your journey through the beautiful landscapes and rich culture of Bangladesh.
            </p>
          </motion.div>
        </div>
      </div>
